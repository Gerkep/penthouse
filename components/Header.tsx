...
const Header = ({onPromotionClick, onContactClick}: any) => {
    ...
    return (
        <HeaderContainer>
            ...
            <Navbar>
                <Link href="https://keznopetnhouse-learnmore.notion.site/Penthouse-Kenzo-bb570472844e49a5b3b92b7721af3edc"><NavbarLink className={styles.roboto}>Learn more</NavbarLink></Link>
                ...
                <div className="mobile-menu-items">
                    <a href="https://keznopetnhouse-learnmore.notion.site/Penthouse-Kenzo-bb570472844e49a5b3b92b7721af3edc" className="mobile-menu-link">Learn more</a>
